package com.microservices.delivery_service.aspect;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.microservices.delivery_service.service..*.*(..))")
    ...
    @Around("execution(* com.microservices.delivery_service.controller..*.*(..))")
