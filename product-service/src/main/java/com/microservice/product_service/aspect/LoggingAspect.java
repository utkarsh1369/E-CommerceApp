package com.microservice.product_service.aspect;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.microservices.product_service.service..*.*(..))")
    ...
    @Around("execution(* com.microservices.product_service.controller..*.*(..))")
